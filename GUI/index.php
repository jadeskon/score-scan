  ...
  <body>
	...
	<div id="content" style="margin-top: 320px; margin-left: 25%; position:absolute; z-index:3;">
		...
		<form align="center" action="upload.php" method="post" enctype="multipart/form-data">
			<!--Datei zum Hochladen -->
			<input class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" type="file" name="fileToUpload" id="fileToUpload">
			<br /><br /><br />
			<input class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" type="submit" value="Datei zu XML umwandeln" name="submit">
		</form>
