...
<html lang="de">
  ...
  <body>
	...
	<div id="content" style="margin-top: 320px; margin-left: 25%; position:absolute; z-index:3;">
		...
		<script>
			setTimeout(function () {window.location.href = "success.php";}, 3200);
		</script>
		
		<!--
		PHP Funktion zum Ausführen eines Kommandozeilenaufrufs zum Starten von Musiknotenscanner
		
			exec('START Python-Interpreter -Pfad zur main.py -Startparameter ');
		-->
